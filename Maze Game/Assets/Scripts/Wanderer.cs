...
public class Wanderer : MonoBehaviour
{
    ...
    void Retarget()
    {
        currentTarget = region.GetRandomPointWithin(); // Get a random target point – call method which is in WanderingRegion
    ...
    void Update()
    {
        if (state == State.Moving)
        {
            ...
            float delta = movespeed * Time.deltaTime; //part of the distance
