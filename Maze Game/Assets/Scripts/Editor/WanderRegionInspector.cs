...
public class WanderRegionInspector : Editor
{
    ...
    void OnSceneGUI() // generate an event
    {
        //Make the handles white:
        Handles.color = Color.white;
        //Draw a wireframe cube resembling the wander region:
        // transform has the access to the  details of the region
        Handles.DrawWireCube(
            Target.transform.position + (Vector3.up * BoxHeight * .5f), 
